...
public class DessertTest {
    ...
    private static final Dessert dessert2 = new Dessert("Sernik", 10.0, cuisine1);
    private static final Dessert dessert3 = new Dessert("Sernik", 10.0, cuisine1);
    private static final Dessert dessert4 = new Dessert("Sernik", 11.5, cuisine1);
    private static final Dessert dessert5 = new Dessert("Pastel de Nata", 11.5, cuisine2);
    ...
    public void shouldFailWhenCuisineIsMissing() throws Exception {
        Throwable thrown = catchThrowable(() -> new MainCourse("Tiramisù", 12.5, null));
